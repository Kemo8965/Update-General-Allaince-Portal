...
import AddVehicleModal from '~/components/modals/add-vehicle-modal.vue'
import AddVehicleFleetModal from '~/components/modals/add-vehicle-fleet-modal.vue'

export default {
  name: 'App2',
  // eslint-disable-next-line vue/no-unused-components
  components: { AddVehicleFleetModal, AddVehicleModal },
  ...
  methods: {
    ...
    toggleVehicleFleetAddition() {
      this.$router.push({
        path: 'components/modals/add-vehicle-fleet-modal.vue',
      })
    },
